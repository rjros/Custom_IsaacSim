...
## Soft Cantilever Beam Benchmark ##
...
class DeformableExample:
    def __init__(self):
        ...
        self.dimx = 5
        self.dimy = 5
        ## Creates a default ground environment, with physics material, and light
    ...
    def makeEnvs(self):
        ...
        for i in range(self.num_envs):
            ...
            physicsUtils.set_or_add_scale_op(skin_mesh,(0.1,0.03,0.03))
